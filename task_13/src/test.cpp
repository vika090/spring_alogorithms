...
TEST(LessonScheduleTest, OneLesson) {
  std::vector<std::pair<double, double>> lessons = {{9.5, 10.5}};
...
TEST(HoursToMinutesTest, NineThree) { EXPECT_EQ(hourstominutes(9.3), 570); }

TEST(HoursToMinutesTest, Ten) { EXPECT_EQ(hourstominutes(10), 600); }

TEST(HoursToMinutesTest, TenFifteen) { EXPECT_EQ(hourstominutes(10.15), 615); }
